...
public class GetMoviesList {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("注意：你的名字。/ 哈利·波特与死亡圣器 / 加勒比海盗 / 12年级的失败");
    }
        ...
        for (int i = 0; i < imdbList.size(); i++) {
            ...
            try {
                ...
                HttpRequest request = HttpRequest.newBuilder()
                        .uri(new URI("https://www.gptapi.us/v1/chat/completions")) // 替换为你的URL
                        .header("Content-Type", "application/json")
                        .header("Authorization", "Bearer sk-h8Zcy96Y7rwjVwgF3a0459A7D40d460d8b7723Ac4449E77b") // 设置你的头信息
    ...
    private static List<String> extractIMDbTop250(String url) {
        // 设置ChromeDriver路径
        System.setProperty("webdriver.chrome.driver", "D:\\Loverorien\\Desktop\\chromedriver-win64\\chromedriver.exe");
